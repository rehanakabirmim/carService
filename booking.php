            ...
            <div class="col-lg-6">
                <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    if (!empty($_POST)) {
                        ...
                        $service_date = htmlentities($_POST['service_date'], ENT_QUOTES);
                        $special_req = htmlentities($_POST['special_req'], ENT_QUOTES);

                        $sql = "INSERT INTO `booking`(`book_name`, `book_email`, `book_ser_name`, `book_ser_date`, `book_req`) VALUES ('$name','$email','$service_name','$service_date','$special_req')";
