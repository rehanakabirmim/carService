...
get_sitebar();
$id = $_GET['v'];
$sel="SELECT * FROM services NATURAL JOIN roles WHERE service_id = $id";
                                    ...
                                    <div class="col-md-8">
                                        <table class="table table-bordered table-striped table-hover custom_view_table">
                                          ...
                                          <tr>
                                            ...
                                            <img height="100" class="img200" src="uploads/<?= $data['service_photo']; ?>" alt="service"/>
                                            <?php }  else{ ?>
